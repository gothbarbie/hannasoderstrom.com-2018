    ...
    <Wrapper>
      <Column>
        <WorkPlace>
          ...
          <Main>
            <P>
              Culture, value and fun is the keywords for Iteam, where I work as
              ...
              value. Not only with technology, but with culture as well. Our
              core values - to produce value, to have fun and to do good -
              influence not only our daily work, but the clients we take on, the
              projects we choose to be a part of and therefore also the
              dedication and eagerness with which we produce really great
              results for a wide range of businesses.
            </P>
            <P>
              My roles has been primarily focused on front end development so
              far, using technologies such as:
            </P>
            <Logos>
        ...
        <WorkPlace>
          ...
          <Main>
            ...
            <P>
              ...
              formats to optimising ads from other medias for the mobile
              platform.
            </P>
            <P>
            ...
            <P>
              Since the mobile web depends on small sized content, we used
              mainly vanilla JavaScript with few additional tools unless we
            ...
            <P>
              We worked with hundreds of famous brands. These are just the ones
        ...
        <WorkPlace>
          ...
          <Main>
            ...
            <P>
              ...
              several different instruments (trombone, piano, drums). I come
              from a very creative family and music and artistic creativity has
              always been close to my heart.
            </P>
            <P>
              I started out my career on the web designing websites and
              gradually learning how to adapt and later create my own
            ...
            <P>
              I made a lot of websites for all sort of smaller businesses,
              models, artists and other clients in need of portfolios and
              similar websites.
            </P>
